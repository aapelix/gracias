...
const SvgAirplay = React.forwardRef<SVGSVGElement, SvgAirplayProps>(
  (props, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M2 1h1v1H2zm1 0h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zM1 2h1v1H1zm9 0h1v1h-1zM1 3h1v1H1zm9 0h1v1h-1zM1 4h1v1H1zm9 0h1v1h-1zM1 5h1v1H1zm9 0h1v1h-1zM1 6h1v1H1zm9 0h1v1h-1zM1 7h1v1H1zm9 0h1v1h-1zM2 8h1v1H2zm3 0h1v1H5zm1 0h1v1H6zm3 0h1v1H9zM4 9h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm-4 1h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z" />
    </svg>
  )
);
